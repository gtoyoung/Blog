...
$url = 'http://www.tfreeca22.com/list.php?b_id=' . $bo_table . '&mode=list&sc=' . $k . '&x=0&y=0&page='.$page.'';
$ch = curl_init();
...
//echo $title . "\n";
//echo $view . "\n";
echo "<item><title>".$title."</title><link>http://localhost/Torrent/download.php?" . $view . "</link><description></description><showrss:showid></showrss:showid><showrss:showname>".$title."</showrss:showname></item>";
}
