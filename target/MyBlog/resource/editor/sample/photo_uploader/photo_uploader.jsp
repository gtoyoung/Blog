...
<body>
	<div id="pop_wrap">
			...
			<form id="editor_upimage" name="editor_upimage" method="post"
				...
				<div id="pop_content2">
					<input type="hidden" name="${_csrf.parameterName}"
						value="${_csrf.token}" /> <input type="file" class="upload"
						id="uploadInputBox" name="Filedata">
					<p class="dsc" id="info">
						<strong>10MB</strong>ì´íì ì´ë¯¸ì§ íì¼ë§ ë±ë¡í  ì ììµëë¤.<br>(JPG, GIF,
						PNG, BMP)
					</p>
				</div>
			</form>
		...
		<div id="pop_container" class="pop_container" style="display: none;">
			...
			<div id="pop_content">
				...
				<div class="drag_area" id="drag_area">
					...
					<em class="blind">ë§ì°ì¤ë¡ ëëê·¸í´ì ì´ë¯¸ì§ë¥¼ ì¶ê°í´ì£¼ì¸ì.</em><span id="guide_text"
						class="bg"></span>
				</div>
				<div style="display: none;" id="divImageList"></div>
				<p class="dsc dsc_v1">
					<em>í ì¥ë¹ 10MB, 1íì 50MBê¹ì§, 10ê°</em>ì ì´ë¯¸ì§ íì¼ì<br>ë±ë¡í  ì ììµëë¤.
					(JPG, GIF, PNG, BMP)
				</p>
			</div>
			<!-- //content -->
		...
		<div id="pop_footer">
			<div class="btn_area">
				<a href="#"><img src="./img/btn_confirm.png" width="49"
					height="28" alt="íì¸" id="btn_confirm"></a> <a href="#"><img
					src="./img/btn_cancel.png" width="48" height="28" alt="ì·¨ì"
					id="btn_cancel"></a>
			</div>
		</div>
		<!-- //footer -->
